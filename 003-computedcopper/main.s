...
.loop           jmp     .loop                                   ; loop in back and do it again.
                ...
                ;-----------------------------------------------------------
initial_colour  dc.w    $0000                                   ; initial colour for the colour bars.
...
generate_colour_bars
                ...
                add.w   #$0100,initial_colour                   ; increment the starting colour of the colour bars (animate the start colour each frame)
                move.w  initial_colour,d1                       ; get the starting colour of the colour bars in data register d1
...
.generate_list
                ...
                move.w  d1,(a0)+                                ; set the 4th word for the copper move instruction (background colour value)

                add.w   #$0100,d0                               ; increment the vertical wait value to the next raster line (copper wait)
                add.w   #$0100,d1                               ; increment the background colour value for the next raster line.
